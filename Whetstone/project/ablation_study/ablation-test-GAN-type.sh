...
#python $python_code ../gan_data/compas/compas-pro-VGAN-ordi-gmm-split-60/8-9/  $dataset-VGAN-ordi-gmm $real$size.csv $prot $priv $pred $pref  
#python $python_code ../gan_data/compas/compas-pro-VGAN-ordi-norm-split-60/8-9/  $dataset-VGAN-ordi-norm $real$size.csv $prot $priv $pred $pref  
...
#python $python_code ../gan_data/compas/compas-pro-TABFAIRGAN/gender/  $dataset-tabfairgan $real$size.csv $prot $priv $pred $pref  
#python $python_code ../gan_data/compas/compas-pro-FAIRGAN/gender/  $dataset-fairgan $real$size.csv $prot $priv $pred $pref  
...
#python $python_code ../gan_data/medical/medical-VGAN-ordi-norm-split-60/8-9/  $dataset-VGAN-ordi-norm $real$size.csv $prot $priv $pred $pref 
#python $python_code ../gan_data/medical/medical-VGAN-ordi-gmm-split-60/8-9/  $dataset-VGAN-ordi-gmm $real$size.csv $prot $priv $pred $pref 
...
python $python_code ../gan_data/bank/bank-full-VGAN-ordi-norm-split-60/8-9/ $dataset-VGAN-ordi-norm $real$size-age.csv $prot $priv $pred $pref 
python $python_code ../gan_data/bank/bank-full-VGAN-ordi-gmm-split-60/8-9/ $dataset-VGAN-ordi-gmm $real$size-age.csv $prot $priv $pred $pref 
...
#python $python_code ../gan_data/adult/adult-VGAN-ordi-gmm-split-60/8-9/  $dataset-VGAN-ordi-gmm $real$size.csv $prot $priv $pred $pref  
#python $python_code ../gan_data/adult/adult-VGAN-ordi-norm-split-60/8-9/  $dataset-VGAN-ordi-norm $real$size.csv $prot $priv $pred $pref  
